...
(function() {
    ...
    function createImageSelector() {
        var imageSelector = document.createElement("select");
        imageSelector.setAttribute("id", "image");
        var body = document.querySeleoctor("body");
        var mainPuzzleArea = document.getElementById("puzzlearea")
        body.appendChild(imageSelector)
    }
    ...
    function createPuzzle() {
        ...
        for (var i = 0; i < 15; i++) {
            ...
            document.getElementById("puzzlearea").appendChild(puzzle);
        }
    }
    ...
    function winOrLose() {
        ...
        if (isSorted) {
            ...
            if (!fastest || timeUsed < fastest)
                fastest = timeUsed;
            if (!fewestMove || moveNumber < fewestMove)
